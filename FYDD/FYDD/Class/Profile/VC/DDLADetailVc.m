...
- (void)updateVerifyUI:(NSString *)userName qualificationNo:(NSString *)qualificationNo{
    ...
    NSMutableAttributedString *string2 = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@" 为我公司指定产品%@，%@的产品范围：制造版、集团版、商贸版;\n",self.userType == DDUserTypeOnline ? @"实施方" : @"代理方",self.userType == DDUserTypeOnline ? @"实施" : @"代理"] attributes:@{NSFontAttributeName: [UIFont fontWithName:@"PingFang SC" size: 14], NSForegroundColorAttributeName: UIColorHex(0x131313)}];
