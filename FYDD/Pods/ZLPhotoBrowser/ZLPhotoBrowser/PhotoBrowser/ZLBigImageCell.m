...
- (void)loadImage:(id)obj
{
    ...
    if ([obj isKindOfClass:UIImage.class]) {
        ...
        zl_weakify(self);
        [self.imageView sd_setImageWithURL:obj placeholderImage:nil options:SDWebImageProgressiveLoad progress:^(NSInteger receivedSize, NSInteger expectedSize, NSURL * _Nullable targetURL) {
            zl_strongify(weakSelf);
            dispatch_async(dispatch_get_main_queue(), ^{
